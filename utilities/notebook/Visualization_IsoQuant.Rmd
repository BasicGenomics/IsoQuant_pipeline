...
conda_path <- "/Users/kawai/miniconda3/envs/R_45_python310/" # Replace the path to your conda envirnment path
viewer_code_path <- "/Users/kawai/Documents/git_hub/isoquant/IsoQuant_pipeline/utilities/for_R/adapter_isoquantviewer.R" # Replace the path to your location of the R code
...
```{r,warning=FALSE}
output_directory <- "~/Documents/data/runs/PR211/results/isoquant_output/" # path to IsoQuantOutput directory
...
* Plots are automatically saved in the folder "plot_output"
...
- plot_count_bar
  ...
  Can either be from the raw count or TPM matrix using "layer", and based on the transcript model or the reference annotation (use_transcript_model=True or False, default is False). Default is plotting all availble samples, but can be limited to specific sample using "sample_id" = [sample1, sample2, and etc.]
  

```{r}
plot_count_bar(viewer,layer='count',
